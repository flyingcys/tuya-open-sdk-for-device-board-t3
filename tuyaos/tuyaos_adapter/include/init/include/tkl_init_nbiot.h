...
typedef struct {
    ...
    OPERATE_RET             (*psm_wakeup_pin_cfg)           (int32_t pin_num, TKL_NB_WAKEUP_CB wakeup_cb);
    //ril
    ...
    OPERATE_RET             (*ril_get_cfun)                 (int32_t *val);
    OPERATE_RET             (*ril_get_rf_flag)              (int32_t *flag);
    ...
    OPERATE_RET             (*ril_get_neightbor_cellid)     (TKL_RIL_NEIGHBOR_CELL_INFO_T **pbuf,  int32_t *out_num);
    //misc
