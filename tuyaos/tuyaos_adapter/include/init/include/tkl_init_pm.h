...
typedef struct {
    ...
    OPERATE_RET     (*set_voltage)(CONST CHAR_T *devname, int32_t mV);
    OPERATE_RET     (*get_voltage)(CONST CHAR_T *devname);
    OPERATE_RET     (*set_current)(CONST CHAR_T *devname,int32_t mA);
    OPERATE_RET     (*get_current)(CONST CHAR_T *devname);
    OPERATE_RET     (*enable)(CONST CHAR_T *devname,int32_t lp_en);
    ...
    OPERATE_RET     (*ioctl)(CONST CHAR_T *devname,int32_t ctl_cmd,void *param);
}TKL_PM_INTF_T;
